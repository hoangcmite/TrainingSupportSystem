...
public class AttendanceTracking extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/view/trainer/AttendanceTracking.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        ArrayList<Schedule> cl = schedule.getClassList();
        ArrayList<SubjectSetting> lsubject = subjects.getSubjectList();
        ArrayList<Attendance> tl = schedule.getAttendance(subjectId, classId);
        
        request.setAttribute("clist", cl);
        request.setAttribute("lsubject", lsubject);
        request.setAttribute("alist", tl);

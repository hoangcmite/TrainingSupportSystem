...
public class ScheduleList extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ScheduleList</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ScheduleList at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/view/supporter/ScheduleList.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        ArrayList<Schedule> cl = schedule.getClassList();
        ArrayList<Schedule> sl = schedule.getScheduleList(classId);

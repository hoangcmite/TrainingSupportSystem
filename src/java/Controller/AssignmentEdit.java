 ...
 * @author asus
 */
@WebServlet(name = "AssignmentEdit", urlPatterns = {"/manager/AssignmentEdit"})
public class AssignmentEdit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("../view/admin/AssignmentEdit.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        AssignmentDao dao = new AssignmentDao();
        dao.editAssignment(id, title, body, status, isTeamWork, isOngoing, subject, eval);

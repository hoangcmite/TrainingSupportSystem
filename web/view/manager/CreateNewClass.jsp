                    ...
                    <form action="AddClass" method="POST" ">
                        <c:if test="${requestScope.mess eq null}">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input pattern=".{0}|.{3,6}" required title="Letters must between 3 and 6" style="width: 450px;" value="" name="ccode" type="text" class="form-control" id="inputEmail3" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Combo <code>(*)</code></label>
                                <div class="col-sm-10">
                                    <select style="width: 450px;" class="form-control" name="cid" required>
                                        <option value="" disabled selected hidden>Combo</option>
                                        <c:forEach items="${lcombo}" var="t">
                                            <option value = "${t.comboId}">${t.getComboName()}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Trainer <code>(*)</code></label>
                                <div class="col-sm-10">
                                    <select style="width: 450px;" class="form-control" name="tid" required>
                            ...
                            <div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Term <code>(*)</code></label>
                                    <div class="col-sm-10">
                                        <select style="width: 450px;" class="form-control" name="term" required>
                                ...
                                ${mess} <a href="/WebApplication2/ClassList" class="alert-link">Return to Class List screen</a>.
                            </div>
                                </c:if>
                            ...
                            <c:if test="${requestScope.mess eq null}">
                                <div style="display: flex;">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-10">
                                            <button style="background-color: gray" onclick="location.href = '/WebApplication2/ClassList'" type="button" class="btn btn-primary">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </c:if>

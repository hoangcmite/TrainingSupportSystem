                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form method="get" action="EvalList">
                                    <div class="row" style="padding: 20px;">
                                        <div class="col-md-10">
                                            <input type="text" value="${param.name}" name="name" class="form-control" style="display: inline; width: 150px;margin-left: 10px;">
                                            <select name="status"   class="form-control" style="display: inline; width: 150px;margin-left: 20px;">
                                                <option value="">All</option>
                                                <option value="1" ${param.status==0?"selected":""}>Active</option>
                                                <option value="0" ${param.status==1?"selected":""}>Inactive</option>
                                            </select >
                                            <select name="assId"  class="form-control" style="display: inline; width: 150px;margin-left: 20px;">
                                                <option value="">All</option>
                                        ...
                                        <div class="col-md-2">
                                            <a href="./AddEval" class="btn btn-primary" style="margin-left: 10px;">Add new</a>
                                        </div>
                                            ...
                                            <tbody>
                                                <c:forEach var="a" items="${elist}">
                                                    <tr>
                                                        ...
                                                        <td><a href="./DeleteEval?eid=${a.id}"><i class="fa-solid fa-trash"></i></a></td>
                                                    </tr>
                                                </c:forEach>

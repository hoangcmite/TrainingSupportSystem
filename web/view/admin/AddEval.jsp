                                ...
                                <form method="post" action="AddEval">
                                    <div class="row" style="width: 100%">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="evalWeight" min="0" max="100">
                                        </div>
                                        <div class="col-md-6">
                                            <label>Max Loc</label>
                                            <input type="number" class="form-control" name="maxLoc" min="0" max="500">
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <br>
                                        <button type="submit" class="btn btn-primary" style="margin: 20px;">Add</button>

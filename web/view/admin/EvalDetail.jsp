                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <h1 >Name : ${e.name}</h1>
                                <h3>Subject: ${e.assignment.subject.code}  </h3>
                                <h3>Assignment: ${e.assignment.title}  </h3>
                                <h4>Eval Weight: ${e.evalWeight}</h4>     
                                <h4>Max Loc: ${e.maxLoc}</h4>
                                <h4>Is team: ${e.isTeamEval?"Yes":"No"} </h4>
                                <h4>Status: ${e.status?"Active":"Inactive"}</h4>
                                <p> Content : ${e.description}</p>
                            </div>
                        </div>
                    </div>
                    <!-- /.container-fluid -->

                        ...
                        <div class="advanced-search">
                            <div style="display: flex;" class = "advanced-search-item first" id="search-1">
                                ...
                                <select class="form-control" id="type" name = "classid" style="width: 280px">
                                    <option value="" disabled selected hidden>Enter Class's Schedule</option>
                            ...
                            <div class = "advanced-search" id="search-4">
                                <button style="margin-left: -15px; width: 70px; height: 35px; font-size: 15px; margin-top: -14px;" onclick="location.href = '/WebApplication2/AddSchedule';" class="btn btn-secondary" type="button">Add</button>
                            </div>
                    </form>
                    <!--                    DataTables Example -->
                                    ...
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                        <thead>
                                            <tr class = "bg-warning" style="text-align: center;">
                                                <th style="width: 70px;" scope="col">
                                                    ...
                                                    <span style="cursor: pointer" onclick="sort(${requestScope.sortId})">Slot</span>                      
                                                </th>
                                                <th style="width: 100px;" scope="col">
                                                    <span style="cursor: pointer" onclick ="sort(${requestScope.sortType})">Subject</span>
                                                </th>
                                                <th style="width: 150px;" scope="col">
                                                    <span style="cursor: pointer" onclick ="sort(${requestScope.sortTitle})">Date</span>
                                                </th>
                                                <th style="width: 150px;" scope="col">
                                                    <span style="cursor: pointer" onclick ="sort(${requestScope.sortValue})">From</span>
                                                </th>
                                                <th style="width: 150px;" scope="col">
                                                    <span style="cursor: pointer" onclick ="sort(${requestScope.sortOrder})">To</span>
                                                </th>
                                        ...
                                        <tbody>
                                            <c:forEach items="${slist}" var="s">
                                                <tr>
                                                    <td style="text-align: center">${s.getSlot()}</td>
                                                    <td style="text-align: center">${s.getSubjectCode()}</td>
                                                   

                                                   <td style="text-align: center"><fmt:formatDate pattern="dd-MM-yyyy" value="${s.getDates()}" /></td> 


                                                    <td style="text-align: center">${s.getFrom()}</td>
                                                    <td style="text-align: center">${s.getTo()}</td>
                                                    <td style="text-align: center">${s.getRoom()}</td>
                                                    <td style="text-align: center">
                                                        <button type="button" class="csw-btn-button" >Take</button>
                                                    </td>     
                                                    <td style="text-align: center">
                                                        <button type="button" onclick="location.href = '/WebApplication2/ScheduleDetails?id=${s.getNumber()}';" class="csw-btn-button" >Edit</button>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>

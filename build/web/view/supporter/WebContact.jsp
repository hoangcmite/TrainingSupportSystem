                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <div>
                                <form action="WebContactDetail">
                                    <input type="submit" value="Detail" style="border-radius: 8px;" />
                                </form>
                                ...
                                <div class = "setting-pagination">
                                    ...
                                    <a class="page-link" href="WebContact?page=${i}" style="border-radius: 8px;">${i}</a>
                                </c:forEach>
                                    </ul>
                                </div>
                            </div>

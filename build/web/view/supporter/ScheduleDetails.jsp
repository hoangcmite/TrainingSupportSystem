                    ...
                    <form action="ScheduleDetails" method="POST">
                        <c:if test="${requestScope.mess eq null}">
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">ID <code>(*)</code></label>
                                <div class="col-sm-10">
                                    <input style="width: 450px;" value="${sche.getNumber()}" name="num" type="text" class="form-control" id="inputEmail3" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input style="width: 450px;" value="${sche.getSlot()}" name="slot" type="number" class="form-control" id="inputEmail3" min="1" max="30" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">From (AM) <code>(*)</code></label>
                                <div class="col-sm-10">
                                    <input required title="Wrong format!" style="width: 450px;" value="${sche.getFrom()}" name="from" type="time" class="form-control" id="inputEmail3" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input required title="Wrong format!" style="width: 450px;" value="${sche.getTo()}" name="to" type="time" class="form-control" id="inputEmail3" required>
                                </div>
                            </div>
                            <div class="form-group row">

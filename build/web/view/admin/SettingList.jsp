                ...
                <div class="container-fluid">
                    ...
                    <form action = "setting" method="GET">
                        <table style="margin-bottom: 15px">
                            <tr>
                                <th><label style="margin-bottom: 0px" for="type" class="mr-sm-2">Filter by Type</label></th>
                                <th><label style="margin-bottom: 0px" for="status" class="mr-sm-2">Filter by Status</label></th>
                                <th><label style="margin-bottom: 0px" for="title" class="mr-sm-2">Search by Title</label></th>
                                <th></th>
                                <th></th>
                            </tr>
                            <tr>
                                <td>
                                    <select class="form-control" id="type" name = "type" style="width: 280px; margin-right: 15px">
                                        <option value>Select the setting type to search</option>
                                        <c:forEach items="${requestScope.listType}" var="t" >
                                            <option ${requestScope.typeId == t.type_id?"selected = selected":""} value = "${t.type_id}">${t.setting_type}</option>
                                        </c:forEach>
                                    </select>
                                </td>
                                <td>
                                    <select class="form-control" id="status" name = "status" style="width: 250px; margin-right: 15px">
                                        ...
                                        <option ${requestScope.status == "1" or requestScope.status == "2"?"selected = selected":""} value = "1">Active</option>
                                        <option ${requestScope.status == "0"?"selected = selected":""} value = "0">Inactive</option>
                                    </select>
                                </td>
                                <td>
                                    <input style="margin-right: 100px" value="${requestScope.title}" type="text" class="form-control" name ="title"  id="title" placeholder="Enter Setting Title You Want To Search" >
                                </td>
                                <td>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <c:forEach items="${requestScope.listSetting}" var="s">
                                            <tr>
                                                <td style="text-align: center">${s.setting_id}</td>
                                                ...
                                                <c:if test="${s.status == 1 or s.status == 2}">
                                                    <td style="text-align: center" id="change">
                                                ...
                                                <td style="text-align: center">
                                                    <c:if test="${s.status == 0}">
                                                        <label class="switch">
                                                            <input  type="checkbox" onclick="active(${s.setting_id})">
                                                            <span class="slider round"></span>
                                                        </label>
                                                    </c:if>
                                                    <c:if test="${s.status == 1 or s.status == 2}">
                                                        <label class="switch">
                                                            <input checked type="checkbox" onclick="inactive(${s.setting_id})">
                                                            <span class="slider round"></span>
                                                        </label>
                                                    </c:if>
                                                    <button class="btn" onclick="editSettingList(${s.setting_id})"><i class="fas fa-edit"></i></button>        
                                                    <button onclick="deleteSetting(${s.setting_id})" type="button" class="btn" ><i class="fa fa-trash"></i></button>
                                                </td>     
                                            </tr>
                                        </c:forEach>
                                    </tbody>
...
//            window.location.href = "../admin/SettingDetails?id=" + id;
                                                            window.location.href = "../admin/setting?go=detail&id=" + id;
                                                        }
                                                                ...
                                                                dangerMode: true,
                                                                    ...
                                                                    .then((willDelete) => {
                                                                        if (willDelete) {
                                                                            ...
                                                                            setTimeout(function () {
                                                                                window.location.href = "/WebApplication2/admin/setting?go=active&id=" + id;
                                                                            }, 1000)
                                                                        } else {
                                                                ...
                                                                dangerMode: true,
                                                                    ...
                                                                    .then((willDelete) => {
                                                                        if (willDelete) {
                                                                            ...
                                                                            setTimeout(function () {
                                                                                window.location.href = "/WebApplication2/admin/setting?go=inactive&id=" + id;
                                                                            }, 1000)
                                                                        } else {
                                                                            window.location.href = "/WebApplication2/admin/setting";
                                                                        }
                                                                    ...
                                                                    .then((willDelete) => {
                                                                        if (willDelete) {
                                                                            swal("Done!", "Your status has been deleted!", "success")
                                                                                    .then((value) => {
                                                                                        window.location.href = "/WebApplication2/admin/setting?go=delete&id=" + id;
                                                                                    });
                                                                        } else {

<%-- 
    ...
    Created on : Oct 10, 2022, 11:07:37 PM
    Author     : dell
--%>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Subject Setting Details</li>
                    </ol>

                    <!--Form edit-->

                    <form action="SubjectSettingDetails" method="POST">
                        <c:if test="${requestScope.mess eq null}">
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Subject Setting ID</label>
                                <div class="col-sm-10">
                                    <input style="width: 450px;" value="${sub.getSettingId()}" name="ssid" type="text" class="form-control" id="inputEmail3" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Subject Code </label>
                                <div class="col-sm-10">
                                    <input style="width: 450px;" value="${sub.getSubjectCode()}" name="scode" type="text" class="form-control" id="inputPassword3" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Setting Value </label>
                                <div class="col-sm-10">
                                    <input style="width: 450px;" value="${sub.getSettingValue()}" name="value" type="text" class="form-control" id="inputPassword3" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Setting Title </label>
                                <div class="col-sm-10">
                                    <input style="width: 450px;" value="${sub.getSettingTitle2()}" name="title" type="text" class="form-control" id="inputPassword3" >
                                </div>
                            </div>
                            ...
                            <c:if test="${requestScope.mess ne null}">
                                <div class="alert alert-success" role="alert">
                                    ${mess} <a href="/WebApplication2/SSettingList" class="alert-link">Return to Subject Setting List screen</a>.
                                </div>
                            </c:if>

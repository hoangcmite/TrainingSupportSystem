<%-- 
    ...
    Created on : Oct 10, 2022, 8:05:11 PM
    Author     : dell
--%>
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <!--Form search-->
                    <form action = "SSettingList" method="POST">
                        <div class="advanced-search">
                            <div class = "advanced-search-item secondd" id="search-1">
                                <label for="type" class="mr-sm-2">Filter by Subject Code</label>
                                <select style="width: 200px" class="form-control" id="type" name = "title">
                            ...
                            <div class = "advanced-search-item secondd" id="search-3">
                                ...
                                <input style="width: 420px" type="text" class="form-control" name ="txt"  id="title" placeholder="Enter title" >
                            </div>
                            ...
                            <div class = "btn-add" >
                                <button style="margin-left: -560px;" onclick="location.href = '/WebApplication2/AddSubjectSetting';" class="btn btn-secondary" type="button">Add</button>
                            </div>
                        </div>
                    </form>
                    <!-- DataTables Example -->
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead>
                                        <tr class = "bg-warning">
                                            ...
                                            <th style="text-align: center" scope="col">
                                                <span onclick ="sort(${requestScope.sortTitle})"> Type </span>
                                            </th>
                                            <th style="text-align: center" scope="col">
                                                <span onclick ="sort(${requestScope.sortTitle})"> Display Order </span>
                                            </th>
                                            <th style="text-align: center" scope="col">
                                                <span onclick ="sort(${requestScope.sortTitle})"> Title </span>
                                            </th>
                                    ...
                                    <tbody>
                                        <c:forEach items="${slist}" var="s">
                                            <tr>
                                                ...
                                                <td>${s.getSettingTitle()}</td>
                                                <td>${s.getDisplayOrder()}</td> 
                                                <td>${s.getSettingTitle2()}</td> 
                                                <c:if test="${s.getStatus() eq false}">
                                                ...
                                                <td style="text-align: center">
                                                    <button type="button" onclick="location.href = '/WebApplication2/SubjectSettingDetails?ssid=${s.getSettingId()}';" class="csw-btn-button" >Edit</button>
                                                </td>     
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                ...
                                <div class = "setting-pagination">
                                    <ul class="pagination" id = "paggerBottom">
                                        <c:forEach begin="1" end="${endP}" var="i">
                                            <a class="page-link" href="SSettingList?index=${i}">${i}</a>
                                        </c:forEach>
                                    </ul>
                                </div>
                            </div>

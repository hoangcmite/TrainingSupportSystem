            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Subject Setting List</li>
                        <li class="breadcrumb-item active">Create New Subject Setting</li>
                    </ol>

                    <!--Form edit-->

                    <form action="AddSubjectSetting" method="POST" ">
                        <c:if test="${requestScope.mess eq null}">
                            <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Subject code <code>(*)</code></label>
                                    <div class="col-sm-10">
                                        <select style="width: 450px;" class="form-control" name="scode" required>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Setting type <code>(*)</code></label>
                                <div class="col-sm-10">
                                    <select style="width: 450px;" class="form-control" name="type" required>
                                        <option value="" disabled selected hidden>type</option>
                                        <c:forEach items="${ltype}" var="t">
                                            <option value = "${t.type_id}">${t.getTypeName()}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Setting title <code>(*)</code></label>
                                <div class="col-sm-10">
                                    <input style="width: 450px;" value="" name="title" type="text" class="form-control" id="inputEmail3" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Setting value <code>(*)</code></label>
                                <div class="col-sm-10">
                                    <input  style="width: 450px;" value="" name="value" type="text" class="form-control" id="inputEmail3" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Display order <code>(*)</code></label>
                                <div class="col-sm-10">
                                    <input  style="width: 450px;" value="" name="order" type="text" class="form-control" id="inputEmail3" required>
                                </div>
                            </div>
                            ...
                            <c:if test="${requestScope.mess ne null}">
                                <div class="alert alert-success" role="alert">
                                    ${mess} <a href="/WebApplication2/SSettingList" class="alert-link">Return to Class List screen</a>.
                                </div>
                            </c:if>
                            ...
                            <c:if test="${requestScope.mess eq null}">
                                <div style="display: flex;">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-10">
                                            <button style="background-color: gray" onclick="location.href = '/WebApplication2/SSettingList'" type="button" class="btn btn-primary">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </c:if>

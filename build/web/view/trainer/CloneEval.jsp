                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form method="post" action="CloneEval">
                                    <div class="row" style="width: 100%">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" value="${e.milestoneId}" class="form-control" name="mid" readonly="">
                                        </div>
                                        <div class="col-md-6">
                                            <label>Eval Weight <code>(*)</code></label>
                                            <input type="number" value="${e.evalWeight}" class="form-control" name="evalWeight" required="" min="1" max="100" >
                                        </div>
                                        <div class="col-md-6">
                                            <label>Max Loc <code>(*)</code></label>
                                            <input type="number" value="${e.maxLoc}" class="form-control" name="maxLoc" required="" min="1" max="1000" >
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea type="text" class="form-control"  maxlength="200" name="description" >${e.description}</textarea>
                                        </div>
                                        <div class="col-md-3">
                                            <button type="submit" class="btn btn-primary" style="margin: 10px;">Clone</button>
                                        </div>
                                        <div class="col-md-6">
                                        </div>
                                    </div>
